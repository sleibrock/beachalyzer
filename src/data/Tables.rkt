...
(struct building (max-level table))
(define (Building #:max-level [max-lvl 1] #:levels [levels '()])
  (building max-lvl levels))
...
(define (get-levels name table)
  (unless (hash? table)
    (error 'get-levels "Hash not provided to get-levels"))
  (unless (hash-has-key? table name)
    (error 'get-levels (format "Building ~a not found" name)))
  (building-table (hash-ref table name)))
   ...
   `(("headquarters"
      . ,(Building
          ...
          (list
           ...
           (cost 21 4780000 4600000 4420000)
           (cost 22 5350000 5150000 5000000)
           (cost 23 5900000 5700000 5400000)
           (cost 24 6500000 6250000 6000000))))
     ("sculptor"
      . ,(Building
          #:max-level 10 
          #:levels
          (list
           ...
           (cost 24 4820000 4820000 4820000)
           (cost 25 5760000 5760000 5760000))))
     ("submarine"
      . ,(Building
          #:max-level 10
          #:levels
     ...
     ("armory"
      . ,(Building
          ...
          (list
           ...
           (cost 22 4580000 4400000 4220000)
           (cost 23 5170000 4970000 4770000)
           (cost 24 5850000 5620000 5390000)
           (cost 25 6610000 6350000 6100000))))
     ("radar"
      . ,(Building
          #:max-level 20
          #:levels
     ...
     ("gunboat"
      . ,(Building
          ...
          (list
           ...
           (cost 22 5100000 4900000 4700000)
           (cost 23 5810000 5590000 5360000)
           (cost 24 6630000 6370000 6110000))))
     ("weaponlab"
      . ,(Building
          #:max-level 7 
          #:levels
          (list
           ...
           (cost 25 5850000 5850000 5850000)
           (cost 25 6100000 6100000 6100000))))
     ("landingcraft"
      . ,(Building
          #:max-level 25
          #:levels
          (list
           ...
           (cost 22 4320000 5080000 4700000)
           (cost 23 4970000 5840000 5410000)
           (cost 24 5710000 6720000 6220000)
           (cost 25 6570000 7730000 7150000))))
     ("residence"
      . ,(Building
         #:max-level 12
         #:levels
         (list
          ...
          (cost 24 2200000 2160000 1220000)
          (cost 25 2600000 2500000 1980000))))
     ("goldstorage"
      . ,(Building
          #:max-level 13
          #:levels
          (list
           ...
           (cost 23 2400000 2300000  890000)
           (cost 24 3560000 3440000 1340000)
           (cost 25 5350000 5160000 2010000))))
     ("woodstorage"
      . ,(Building
          #:max-level 13
          #:levels
          (list
           ...
           (cost 23 1140000 1020000 450000)
           (cost 24 1710000 1530000 670000)
           (cost 25 2560000 2295000 100000))))
     ("stonestorage"
      . ,(Building
          #:max-level 13
          #:levels
          (list
           ...
           (cost 23 1620000 1340000  840000)
           (cost 24 2430000 2010000 1260000)
           (cost 25 3650000 3015000 1890000))))
     ("ironstorage"
      . ,(Building
          #:max-level 13
          #:levels
          (list
           ...
           (cost 23 1900000 1890000 1480000)
           (cost 24 2910000 2835000 2230000)
           (cost 25 4370000 4250000 3340000))))
     ("vault"
      . ,(Building
          #:max-level 21
          #:levels
          (list
           ...
           (cost 24 2310000 2310000 2310000))))
     ("sawmill"
      . ,(Building
          #:max-level 10
          #:levels
     ...
     ("sniper"
      . ,(Building
          ...
          (list
           ...
           (cost 22 3380000 3100000 2820000)
           (cost 23 4060000 3720000 3380000)
           (cost 24 4870000 4460000 4060000)
           (cost 25 5840000 5360000 4870000))))
     ("machinegun"
      . ,(Building
          #:max-level 25
          #:levels
          (list
           ...
           (cost 22 3150000 2900000 3400000)
           (cost 23 3590000 3310000 3880000)
           (cost 24 4090000 3770000 4420000)
           (cost 25 4670000 4300000 5040000))))
     ("mortar"
      . ,(Building
          #:max-level 27
          #:levels
         (list
          ...
          (cost 22 3750000 3400000 3360000)
          (cost 23 4130000 3740000 3700000)
          (cost 23 4330000 3930000 3890000)
          (cost 24 4760000 4320000 4270000)
          (cost 24 5000000 4530000 4480000)
          (cost 25 5500000 4990000 4930000))))
     ("cannon"
      . ,(Building
          #:max-level 25
          #:levels
          (list
           ...
           (cost 22 3130000 3400000 3670000)
           (cost 23 3500000 3800000 4110000)
           (cost 24 3930000 4260000 4600000)
           (cost 25 4400000 4780000 5160000))))
     ("flamethrower"
      . ,(Building
          #:max-level 23
          #:levels
          (list
           ...
           (cost 22 2710000 3190000 2950000)
           (cost 23 3040000 3570000 3300000)
           (cost 23 3220000 3790000 3500000)
           (cost 24 3600000 4240000 3920000)
           (cost 25 4040000 4750000 4390000))))
     ("boomcannon"
      . ,(Building
          #:max-level 19
          #:levels
          (list
           ...
           (cost 22 3900000 4210000 3590000)
           (cost 23 4680000 5050000 4310000)
           (cost 24 5620000 6060000 5170000)
           (cost 25 6740000 7270000 6200000))))
    ("rocketlauncher"
     . ,(Building
         #:max-level 17
         #:levels
         (list
          ...
          (cost 20 2060000 2060000 2050000)
          (cost 20 2470000 2470000 2460000)
          (cost 21 4210000 3590000 3900000)
          (cost 23 5050000 4310000 4680000)
          (cost 24 6060000 5170000 5620000)
          (cost 25 7270000 6200000 6000000))))
    ("shocklauncher"
     . ,(Building
         #:max-level 11
         #:levels
         (list
          ...
          (cost 20 2880000 2880000 2870000)
          (cost 20 3300000 3300000 3300000)
          (cost 21 4320000 4700000 5080000)
          (cost 25 5400000 5870000 6000000))))
    )))
...
(module+ test
  ...
  (test-case "Testing each building has the correct amount of levels"
    (define buildings (hash->list all-buildings))
    (for ([b buildings])
      (let ([building-name (car b)]
            [building-data (cdr b)])
        (check-eq? (building-max-level building-data)
                   (length (building-table building-data))))))
  )
